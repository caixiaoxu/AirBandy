 ...
 *
 */
class Table1(res: Resources) : Shape(res) {
    ...
    override fun loadVertexShader(): String = "vshader/color_vertex_shader.glsl"

    override fun loadFragmentShader(): String = "fshader/color_fragment_shader.glsl"
